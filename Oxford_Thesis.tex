...
\usepackage[style=numeric-comp, sorting=none, backend=biber, doi=false, isbn=false, backend=bibtex]{biblatex}
...
\include{text/ch2-shuttling}
\include{text/ch3-optimal-control}
